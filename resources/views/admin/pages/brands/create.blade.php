                                        ...
                                        <div class="fv-row">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 mb-7">
                                                    ...
                                                    <x-metronic.select-option id="city_id" name="city_id[]"
                                                        data-hide-search="false" multiple
                                                        data-placeholder="Select an option">
                                                        <option></option>
                                                ...
                                                <div class="col-lg-3 mb-7">
                                                    ...
                                                    <x-metronic.select-option id="area_id" name="area_id[]"
                                                        data-hide-search="false" multiple
                                                        data-placeholder="Select an option">
                                                        <option></option>
                                                ...
                                                <div class="col-lg-12 mb-7">
                                                    ...
                                                    <x-metronic.input id="offer_description_title" type="text"
                                                        name="offer_description_title" :value="old('offer_description_title')"
                                                ...
                                                <div class="col-lg-12 mb-7">
                                                    ...
                                                    <x-metronic.input id="description_title" type="text"
