<div class="row">
    ...
    <div class="col-lg-3 col-md-6 mb-7">
        <x-metronic.label for="city_id" class="col-form-label fw-bold fs-6">{{ __('Select City') }}</x-metronic.label>
    ...
    <div class="col-lg-3 col-md-6 mb-7">
        <x-metronic.label for="area_id" class="col-form-label fw-bold fs-6">{{ __('Select Area') }}</x-metronic.label>
    ...
    <div class="col-lg-3 col-md-6 mb-7">
        ...
        <x-metronic.input id="name" type="text" name="name" :value="old('name')" placeholder="Enter the Name"
    ...
    <div class="col-lg-12 mb-7">
        <x-metronic.label for="about_title" class="col-form-label fw-bold fs-6 required">{{ __('Section One Title') }}
        </x-metronic.label>
    ...
    <div class="col-lg-12 mb-7">
        <x-metronic.label for="description" class="col-form-label fw-bold fs-6">{{ __('Section Four Description') }}
        </x-metronic.label>
...
<div class="row mt-2 justify-content-end">
    <div class="d-flex align-items-center justify-content-end">
        <a class="btn btn-lg btn-info rounded-0 tab-trigger-next" data-bs-toggle="tab"
