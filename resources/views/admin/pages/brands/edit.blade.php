                        ...
                        <x-metronic.select-option id="country_id" name="country_id[]" data-hide-search="false" multiple
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country->id }}"
                                    {{ in_array($country->id, old('country_id', $brand->country_id->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{ $country->name }}</option>
                            @endforeach
                        </x-metronic.select-option>
                    </div>
                        ...
                        <x-metronic.select-option id="division_id" name="division_id[]" data-hide-search="false"
                            ...
                            @foreach ($divisions as $division)
                                <option value="{{ $division->id }}"
                                    {{ in_array($division->id, old('division_id', $brand->division_id->pluck('id')->toArray())) ? 'selected' : '' }}>
                        ...
                        <x-metronic.select-option id="city_id" name="city_id[]" data-hide-search="false" multiple
                            ...
                            @foreach ($cities as $city)
                                <option value="{{ $city->id }}"
                                    {{ in_array($city->id, old('city_id', $brand->city_id->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{ $city->name }}</option>
                            @endforeach
                        </x-metronic.select-option>
                    </div>
                        ...
                        <x-metronic.select-option id="area_id" name="area_id[]" data-hide-search="false" multiple
                            ...
                            @foreach ($areas as $area)
                                <option value="{{ $area->id }}"
                                    {{ in_array($area->id, old('area_id', $brand->area_id->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{ $area->name }}</option>
                            @endforeach
                        </x-metronic.select-option>
                    </div>
