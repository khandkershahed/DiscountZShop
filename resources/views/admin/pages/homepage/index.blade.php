<x-admin-app-layout :title="'Home Page List'">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($homePages as $key => $homepage)
                        <tr>
                            ...
                            <td class="">
                                <img src="{{ !empty($homepage->top_banner) ? url('storage/' . $homepage->top_banner) : 'https://ui-avatars.com/api/?name=' . urlencode($homepage->name) }}"
                                    height="40" width="40" alt="{{ $homepage->name }}">
