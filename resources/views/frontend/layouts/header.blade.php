                            ...
                            <div>
                                <a href="{{ route('homePage') }}" class="logo-main">
                                    <img class="img-fluid"
                                        ...
                                        alt="Company Logo"
                                        onerror="this.onerror=null; this.src='http://www.discountzshop.com/storage/webSetting/site_logo_black/oWIkHcvg6U1725872126.png';">
                                </a>
                            </div>
                            <div>
                                                ...
                                                <div class="col-lg-3 bg-white px-0 category-menus">
                                                    ...
                                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                            <li class="nav-item d-flex align-items-center">
                                                                <!-- Current Location -->
                                                                <a class="nav-link current-location shadow-sm"
                                                                    aria-current="page"
                                                                    title="Location Wise Current Discount"
                                                                    href="javascript:;">
                                                                ...
                                                                <div class="dropdown position-static">
                                                                    ...
                                                                    @if ($categories->count() > 0)
                                                                        <a href="javascript:void(0)"
                                                                            class="dropdown-toggle ms-3 category-menu"
                                                                            type="button"
                                                                        ...
                                                                        <ul class="dropdown-menu w-100 border-0 bg-light mt-0 rounded-0 py-0"
                                                                            ...
                                                                            <div class="container">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div
                                                                                        class="col-lg-3 bg-white px-0 category-menus">
                                ...
                                @endforeach
                                                        ...
                                                        <form class="d-flex" action="{{ route('product.search') }}"
                                                            ...
                                                            <div class="d-flex hdr-search align-items-center">
                                                                ...
                                                                <input class="form-control hdr-search-box"
                                                                    autocomplete="on" required name="search"
                                                                    type="text" placeholder="Search"
                                                                    aria-label="Search" />
                                                            </div>

                                                            <button
                                                                class="btn position-relative border-0 bg-transparent search-action"
                                                                type="submit">
