            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="store-single pt-3">
                        ...
                        <li data-target="popular-discount">Popular Discount</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 ps-0">
                    <div>
                        <img class="img-fluid w-100 rounded-2" src="{{ asset('frontend') }}/assets/img/store/store-banner-1.png"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6 pe-0">
                    <div>
                        <img class="img-fluid w-100 rounded-2" src="{{ asset('frontend') }}/assets/img/store/store-banner-3.png"
                            alt="">
                    </div>
                </div>
            </div>
