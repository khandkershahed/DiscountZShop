                                                    ...
                                                    <div class="content-area"
                                                        ...
                                                        <div class="p-1 ">
                                                            <h5 class="discount-percentage text-center fw-bold pt-2">
                                                                {{ $coupon->badge }}</h5>
                                                            <p
                                                                class="text-white text-center ps-1 pt-1 pb-1 coupon-text">
                                                                OFF
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <p
                                                                class="text-white text-center coupon-text coupon-code pt-2">
                                                                Code:
    ...
    <div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex align-items-center justify-content-end w-100 py-2">
                                            <div class="coupon-images-mb">
                                                <img class="" src="http://www.discountzshop.com/storage/coupon/logo/W1L8VtY8hA1729401322.jpg" alt="">
                                            </div>
                                            <div>
            ...
            <div class="row bg-panda mt-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center py-3">
                        ...
                        <div>
                            <input type="email" class="form-control form-control-sm rounded-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-2 bg-light py-4">
                <div class="col-12">
                    <ul class="nav nav-tabs border-0 d-flex justify-content-center align-items-center" id="myTab" role="tablist">
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Hot Deals</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Cashback</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Flat %</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Buy 1 Get 1</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Upto 50%</button>
                        </li>
                      </ul>
                      <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row g-2 mt-3">
                                <div class="col-4">
                                    <div class="card p-0" style="border: 2px dashed #eee">
                                        <div class="card-body p-1 py-3 d-flex justify-content-between align-items-center">
                                            <div class="offers-img">
                                                <img src="http://www.discountzshop.com/storage/offer/logo/STJH9w5hbH1728190151.png" alt="">
                                            </div>
                                            <div>
            ...
            <div class="row mt-2 bg-light py-4 pt-0 pb-0">
                ...
                <div class="col-12">
                    <ul class="nav nav-tabs border-0 d-flex justify-content-center align-items-center" id="myTab" role="tablist">
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs active" id="home2-tab" data-bs-toggle="tab" data-bs-target="#home2" type="button" role="tab" aria-controls="home2" aria-selected="true">Hot Deals</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2" type="button" role="tab" aria-controls="profile2" aria-selected="false">Cashback</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact2-tab" data-bs-toggle="tab" data-bs-target="#contact2" type="button" role="tab" aria-controls="contact2" aria-selected="false">Flat %</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact2-tab" data-bs-toggle="tab" data-bs-target="#contact2" type="button" role="tab" aria-controls="contact2" aria-selected="false">Buy 1 Get 1</button>
                        </li>
                        <li class="nav-item me-1 mb-2" role="presentation">
                          <button class="nav-link mb-link-tabs" id="contact2-tab" data-bs-toggle="tab" data-bs-target="#contact2" type="button" role="tab" aria-controls="contact2" aria-selected="false">Upto 50%</button>
                        </li>
                      </ul>
                      <div class="tab-content" id="myTabContent">
                                ...
                                <div class="col-6">
                                    <div class="card p-0 rounded-3">
                                        <div class="card-header p-0">
                                            <div class="p-0">
                                                <div>
                                                    <img class="img-fluid w-100" src="{{ asset('images/bata-banner.png') }}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center py-2 px-2">
                                                    <div>
                                                        <img class="img-fluid" src="{{ asset('images/daraz.png') }}" alt="">
                                                    </div>
                                                    <div class="ps-2">
                                                        <h6 class="mb-0">Free Delivery on order</h6>
                                                    </div>
                                                </div>
                                                <div class="py-2 pt-0 px-2">
                                                    <p class="mb-0"><small>Daraz's Free Delivery Festival in 2024</small></p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="profile2" role="tabpanel" aria-labelledby="profile2-tab">...</div>
            ...
            <div class="row bg-light" style="margin-bottom: 6rem">
                ...
                <div class="col-12">
                    <div class="d-flex justiy-content-between align-items-center my-4">
                        <div>
                            <img class="img-fluid" src="{{ asset('images/kfc-logo.png') }}" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{ asset('images/bd-ticket.png') }}" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{ asset('images/kfc-logo.png') }}" alt="">
                        </div>
