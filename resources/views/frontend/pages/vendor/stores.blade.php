<x-frontend-app-layout :title="'Brand Stores || DiscountZShop'">
    ...
    <section id="location" class="mb-5">
        <div class="container pt-2">
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="pt-1 d-flex justify-content-space-around align-items-center footer-icons">
                            <a href="" class="p-2">
                                <i class="fas fa-globe site-color" style="font-size: 22px" aria-hidden="true" title="Website"></i>
                            </a>
                            <a href="" class="p-2">
                                <i class="fa-brands fa-facebook-f site-color" style="font-size: 22px" aria-hidden="true"
                                    title="Facebook"></i>
                            </a>
                            <a href="" class="p-2">
                                <i class="fa-brands fa-twitter site-color" style="font-size: 22px" aria-hidden="true"
                                    title="Twitter"></i>
                            </a>

                            <a href="" class="p-2">
                                <i class="fa-brands fa-linkedin-in site-color" style="font-size: 22px" aria-hidden="true"
                                    title="Linkedin"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-5">
                    <div class="brands-stores"
                        style="max-height: 475px;overflow-y: auto;border: 1px solid #eee;">
