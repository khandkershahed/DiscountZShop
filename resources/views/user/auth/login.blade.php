<x-frontend-app-layout :title="'All Brands || DiscountZShop'">
    ...
    <div class="mobile-homepage" style="margin-top: 6rem;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center pt-5">
                        <h1>Welcome Back</h1>
                        <p class="pt-2">Sign in to access your account</p>
                    </div>
                    <div class="p-5 px-4">
                        <div class="">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('password.request') }}" class="site-text mfs">Forgot password?</a>
                            </div>
                        </div>
                        <div>
                            <div class="login-mobile">
                                <button class="mobile-login-btn">Login</button>
                                <p class="text-center">New Member? <a href="{{ route('register') }}"><span class="site-text">Register Now</span></a></p>
                            </div>
                        </div>
                    </div>
                </div>
